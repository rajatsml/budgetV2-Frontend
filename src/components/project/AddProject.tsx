        ...
        <div className="card bg-base-100 shadow-sm border border-base-300">
          <div className="card-body gap-8">
            ...
            <div>
              ...
              {/* Row 1: Project Name, Type, Financial Year, Start Date, End Date */}
            ...
            {/* 02. Assign Departments and Hierarchy */}
            <div>
              <div className="flex items-center gap-3 border-b border-base-200 pb-4 mb-6">
                <div className="badge badge-neutral w-7 h-7 font-mono p-0 rounded-full flex items-center justify-center text-xs">
                  02
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="form-control gap-2">
                  ...
                  <div className="flex flex-wrap gap-2 items-center p-2 rounded border border-base-300 bg-base-200/30">
                    ...
                    >
                      ...
                      {isOpen && (
                        <div className="dropdown-content menu p-3 shadow-lg bg-base-100 border border-base-200 rounded-xl w-full z-50 mt-1 space-y-2">
                ...
                <div className="form-control w-full">
                  ...
                  <p className="text-xs text-base-content/50 mt-1">
                    Number of approval levels for each department.
                  </p>
                </div>
              </div>
            </div>

            {/* 03. Approver Assignment Matrix */}
              ...
              <div>
                <div className="flex items-center gap-3 border-b border-base-200 pb-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-base-content/60">
                      Search and map employee signatures required per assigned
                      division tier.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  {selectedDeps.map((dept) => (
                    ...
                    >
                      <div className="flex items-center justify-between gap-3 border-b border-base-200/60 pb-3">
                      ...
                      {/* Single Row: Maker + All Approvers */}
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="form-control w-full">
                          ...
                          <details className="dropdown w-full relative">
                            ...
                            <div className="dropdown-content menu p-2 shadow-xl bg-base-100 border border-base-200 rounded-lg w-full min-w-60 mt-1 space-y-2 z-50 absolute left-0 top-full">
                              <input
                                type="text"
                        ...
                        {hierarchyLevels.map((level) => {
                          ...
                          const currentSearch = empSearchTerms[uniqueKey] || "";
                            ...
                            >
                              ...
                              <details className="dropdown w-full relative">
                                <summary className="btn btn-sm btn-outline border-base-300 bg-base-100 text-base-content justify-between w-full font-medium rounded-md normal-case list-none h-9 px-3">
                                  {currentSignee ? (
                                    <span className="text-sm font-semibold truncate text-neutral">
                                      {currentSignee.id} — {currentSignee.name}
                                    </span>
                                  ) : (
                                    <span className="text-xs text-base-content/40 font-normal">
                                      Select Approver...
            ...
            <div className="flex gap-2 pt-6 border-t border-base-200">
              <button
                type="button"
                onClick={() => handleCreateProject("Draft")}
                className="btn btn-ghost btn-sm normal-case text-base-content/70 hover:text-base-content"
              ...
              <button
                ...
                className="btn btn-neutral btn-sm gap-2 rounded-xl normal-case"
                disabled={loading || loadingProject || !canEditProject}
              >
                <FileText size={16} />
                {loading
